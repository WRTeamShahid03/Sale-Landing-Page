            ...
            <div className="container">
                <div className="row commonRowGap">
                    <div className="col-xl-6">
                        <CommonTextDiv blueText={`${products?.length} Awesome Products`} title={`Browse Through Our Collection of ${products?.length} Awesome Products Designed for Your Next Project!`} desc={`Find everything you need to make your project a success and get inspired along the way.`} />
                    </div>
